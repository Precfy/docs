...
| `content.devedor.nome`                             | String                     | Informações sobre o devedor, incluindo o nome, sigla (se aplicável) e esfera judicial (ex: "FEDERAL").   |
| `content.devedor.sigla`                            | String                     | Informações sobre o devedor, incluindo o nome, sigla (se aplicável) e esfera judicial (ex: "FEDERAL").   |
| `content.devedor.esfera`                           | String                     | Informações sobre o devedor, incluindo o nome, sigla (se aplicável) e esfera judicial (ex: "FEDERAL").   |
